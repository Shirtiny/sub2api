...
type UserEdges struct {
	...
	// SubscriptionConcurrencyEntitlements holds the value of the subscription_concurrency_entitlements edge.
	SubscriptionConcurrencyEntitlements []*SubscriptionConcurrencyEntitlement `json:"subscription_concurrency_entitlements,omitempty"`
	...
	// CafeCoupons holds the value of the cafe_coupons edge.
	CafeCoupons []*CafeCoupon `json:"cafe_coupons,omitempty"`
...
// SubscriptionConcurrencyEntitlementsOrErr returns the SubscriptionConcurrencyEntitlements value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) SubscriptionConcurrencyEntitlementsOrErr() ([]*SubscriptionConcurrencyEntitlement, error) {
	if e.loadedTypes[3] {
		return e.SubscriptionConcurrencyEntitlements, nil
	}
	return nil, &NotLoadedError{edge: "subscription_concurrency_entitlements"}
}
...
// CafeCouponsOrErr returns the CafeCoupons value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) CafeCouponsOrErr() ([]*CafeCoupon, error) {
	if e.loadedTypes[11] {
		return e.CafeCoupons, nil
	}
	return nil, &NotLoadedError{edge: "cafe_coupons"}
}
...
// QuerySubscriptionConcurrencyEntitlements queries the "subscription_concurrency_entitlements" edge of the User entity.
func (_m *User) QuerySubscriptionConcurrencyEntitlements() *SubscriptionConcurrencyEntitlementQuery {
	return NewUserClient(_m.config).QuerySubscriptionConcurrencyEntitlements(_m)
}
...
// QueryCafeCoupons queries the "cafe_coupons" edge of the User entity.
func (_m *User) QueryCafeCoupons() *CafeCouponQuery {
	return NewUserClient(_m.config).QueryCafeCoupons(_m)
}
