...
func init() {
	...
	// apikeyDescKeyHashAlg is the schema descriptor for key_hash_alg field.
	apikeyDescKeyHashAlg := apikeyFields[3].Descriptor()
	// apikey.DefaultKeyHashAlg holds the default value on creation for the key_hash_alg field.
	apikey.DefaultKeyHashAlg = apikeyDescKeyHashAlg.Default.(string)
	// apikey.KeyHashAlgValidator is a validator for the "key_hash_alg" field. It is called by the builders before save.
	apikey.KeyHashAlgValidator = apikeyDescKeyHashAlg.Validators[0].(func(string) error)
	// apikeyDescKeyLookupHash is the schema descriptor for key_lookup_hash field.
	apikeyDescKeyLookupHash := apikeyFields[4].Descriptor()
	// apikey.KeyLookupHashValidator is a validator for the "key_lookup_hash" field. It is called by the builders before save.
	apikey.KeyLookupHashValidator = apikeyDescKeyLookupHash.Validators[0].(func(string) error)
	...
	apikeyDescName := apikeyFields[6].Descriptor()
	...
	cafecouponDescCode := cafecouponFields[0].Descriptor()
	// cafecoupon.CodeValidator is a validator for the "code" field. It is called by the builders before save.
	cafecoupon.CodeValidator = func() func(string) error {
		validators := cafecouponDescCode.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// cafecouponDescMembershipLevel is the schema descriptor for membership_level field.
	cafecouponDescMembershipLevel := cafecouponFields[2].Descriptor()
	// cafecoupon.DefaultMembershipLevel holds the default value on creation for the membership_level field.
	cafecoupon.DefaultMembershipLevel = cafecouponDescMembershipLevel.Default.(int)
	// cafecouponDescCouponType is the schema descriptor for coupon_type field.
	cafecouponDescCouponType := cafecouponFields[3].Descriptor()
	// cafecoupon.CouponTypeValidator is a validator for the "coupon_type" field. It is called by the builders before save.
	cafecoupon.CouponTypeValidator = cafecouponDescCouponType.Validators[0].(func(string) error)
	// cafecouponDescPeriod is the schema descriptor for period field.
	cafecouponDescPeriod := cafecouponFields[5].Descriptor()
	// cafecoupon.DefaultPeriod holds the default value on creation for the period field.
	cafecoupon.DefaultPeriod = cafecouponDescPeriod.Default.(string)
	// cafecoupon.PeriodValidator is a validator for the "period" field. It is called by the builders before save.
	cafecoupon.PeriodValidator = cafecouponDescPeriod.Validators[0].(func(string) error)
	// cafecouponDescStatus is the schema descriptor for status field.
	cafecouponDescStatus := cafecouponFields[8].Descriptor()
	// cafecoupon.DefaultStatus holds the default value on creation for the status field.
	cafecoupon.DefaultStatus = cafecouponDescStatus.Default.(string)
	// cafecoupon.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	cafecoupon.StatusValidator = cafecouponDescStatus.Validators[0].(func(string) error)
	// cafecouponDescCreatedAt is the schema descriptor for created_at field.
	cafecouponDescCreatedAt := cafecouponFields[11].Descriptor()
	// cafecoupon.DefaultCreatedAt holds the default value on creation for the created_at field.
	cafecoupon.DefaultCreatedAt = cafecouponDescCreatedAt.Default.(func() time.Time)
	// cafecouponDescUpdatedAt is the schema descriptor for updated_at field.
	cafecouponDescUpdatedAt := cafecouponFields[12].Descriptor()
	// cafecoupon.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	cafecoupon.DefaultUpdatedAt = cafecouponDescUpdatedAt.Default.(func() time.Time)
	// cafecoupon.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	cafecoupon.UpdateDefaultUpdatedAt = cafecouponDescUpdatedAt.UpdateDefault.(func() time.Time)
	...
	groupDescIsCustomSubscriptionGroup := groupFields[38].Descriptor()
	...
	// paymentorderDescCafeCouponCode is the schema descriptor for cafe_coupon_code field.
	paymentorderDescCafeCouponCode := paymentorderFields[8].Descriptor()
	// paymentorder.CafeCouponCodeValidator is a validator for the "cafe_coupon_code" field. It is called by the builders before save.
	paymentorder.CafeCouponCodeValidator = paymentorderDescCafeCouponCode.Validators[0].(func(string) error)
	// paymentorderDescCafeCouponDiscount is the schema descriptor for cafe_coupon_discount field.
	paymentorderDescCafeCouponDiscount := paymentorderFields[9].Descriptor()
	// paymentorder.DefaultCafeCouponDiscount holds the default value on creation for the cafe_coupon_discount field.
	paymentorder.DefaultCafeCouponDiscount = paymentorderDescCafeCouponDiscount.Default.(float64)
	...
	// paymentorderDescPresaleRenewal is the schema descriptor for presale_renewal field.
	paymentorderDescPresaleRenewal := paymentorderFields[22].Descriptor()
	// paymentorder.DefaultPresaleRenewal holds the default value on creation for the presale_renewal field.
	paymentorder.DefaultPresaleRenewal = paymentorderDescPresaleRenewal.Default.(bool)
	// paymentorderDescPresalePlanName is the schema descriptor for presale_plan_name field.
	paymentorderDescPresalePlanName := paymentorderFields[23].Descriptor()
	// paymentorder.DefaultPresalePlanName holds the default value on creation for the presale_plan_name field.
	paymentorder.DefaultPresalePlanName = paymentorderDescPresalePlanName.Default.(string)
	// paymentorder.PresalePlanNameValidator is a validator for the "presale_plan_name" field. It is called by the builders before save.
	paymentorder.PresalePlanNameValidator = paymentorderDescPresalePlanName.Validators[0].(func(string) error)
	// paymentorderDescPresaleResetCards is the schema descriptor for presale_reset_cards field.
	paymentorderDescPresaleResetCards := paymentorderFields[24].Descriptor()
	// paymentorder.DefaultPresaleResetCards holds the default value on creation for the presale_reset_cards field.
	paymentorder.DefaultPresaleResetCards = paymentorderDescPresaleResetCards.Default.(int)
	// paymentorder.PresaleResetCardsValidator is a validator for the "presale_reset_cards" field. It is called by the builders before save.
	paymentorder.PresaleResetCardsValidator = func() func(int) error {
		validators := paymentorderDescPresaleResetCards.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(presale_reset_cards int) error {
			for _, fn := range fns {
				if err := fn(presale_reset_cards); err != nil {
					return err
				}
			}
			return nil
	...
	// paymentorderDescPresaleBalanceBonusAmount is the schema descriptor for presale_balance_bonus_amount field.
	paymentorderDescPresaleBalanceBonusAmount := paymentorderFields[26].Descriptor()
	// paymentorder.DefaultPresaleBalanceBonusAmount holds the default value on creation for the presale_balance_bonus_amount field.
	paymentorder.DefaultPresaleBalanceBonusAmount = paymentorderDescPresaleBalanceBonusAmount.Default.(float64)
	// paymentorder.PresaleBalanceBonusAmountValidator is a validator for the "presale_balance_bonus_amount" field. It is called by the builders before save.
	paymentorder.PresaleBalanceBonusAmountValidator = paymentorderDescPresaleBalanceBonusAmount.Validators[0].(func(float64) error)
	// paymentorderDescPresaleBalanceBonusCurrency is the schema descriptor for presale_balance_bonus_currency field.
	paymentorderDescPresaleBalanceBonusCurrency := paymentorderFields[27].Descriptor()
	// paymentorder.DefaultPresaleBalanceBonusCurrency holds the default value on creation for the presale_balance_bonus_currency field.
	paymentorder.DefaultPresaleBalanceBonusCurrency = paymentorderDescPresaleBalanceBonusCurrency.Default.(string)
	// paymentorder.PresaleBalanceBonusCurrencyValidator is a validator for the "presale_balance_bonus_currency" field. It is called by the builders before save.
	paymentorder.PresaleBalanceBonusCurrencyValidator = paymentorderDescPresaleBalanceBonusCurrency.Validators[0].(func(string) error)
	// paymentorderDescPresaleBalanceBonusFaceAmount is the schema descriptor for presale_balance_bonus_face_amount field.
	paymentorderDescPresaleBalanceBonusFaceAmount := paymentorderFields[28].Descriptor()
	// paymentorder.DefaultPresaleBalanceBonusFaceAmount holds the default value on creation for the presale_balance_bonus_face_amount field.
	paymentorder.DefaultPresaleBalanceBonusFaceAmount = paymentorderDescPresaleBalanceBonusFaceAmount.Default.(float64)
	// paymentorder.PresaleBalanceBonusFaceAmountValidator is a validator for the "presale_balance_bonus_face_amount" field. It is called by the builders before save.
	paymentorder.PresaleBalanceBonusFaceAmountValidator = paymentorderDescPresaleBalanceBonusFaceAmount.Validators[0].(func(float64) error)
	// paymentorderDescPresaleBalanceBonusRate is the schema descriptor for presale_balance_bonus_rate field.
	paymentorderDescPresaleBalanceBonusRate := paymentorderFields[29].Descriptor()
	// paymentorder.DefaultPresaleBalanceBonusRate holds the default value on creation for the presale_balance_bonus_rate field.
	paymentorder.DefaultPresaleBalanceBonusRate = paymentorderDescPresaleBalanceBonusRate.Default.(float64)
	// paymentorder.PresaleBalanceBonusRateValidator is a validator for the "presale_balance_bonus_rate" field. It is called by the builders before save.
	paymentorder.PresaleBalanceBonusRateValidator = paymentorderDescPresaleBalanceBonusRate.Validators[0].(func(float64) error)
	// paymentorderDescSubscriptionBonusDays is the schema descriptor for subscription_bonus_days field.
	paymentorderDescSubscriptionBonusDays := paymentorderFields[33].Descriptor()
	...
	paymentorderDescSubscriptionConcurrency := paymentorderFields[34].Descriptor()
	...
	paymentorderDescSubscriptionEarlyResetEnabled := paymentorderFields[35].Descriptor()
	...
	paymentorderDescSubscriptionEarlyResetDurationDays := paymentorderFields[36].Descriptor()
	...
	paymentorderDescRefundRequestedBy := paymentorderFields[51].Descriptor()
	...
	// promotionactivityDescBonusCurrency is the schema descriptor for bonus_currency field.
	promotionactivityDescBonusCurrency := promotionactivityFields[2].Descriptor()
	// promotionactivity.DefaultBonusCurrency holds the default value on creation for the bonus_currency field.
	promotionactivity.DefaultBonusCurrency = promotionactivityDescBonusCurrency.Default.(string)
	// promotionactivity.BonusCurrencyValidator is a validator for the "bonus_currency" field. It is called by the builders before save.
	promotionactivity.BonusCurrencyValidator = promotionactivityDescBonusCurrency.Validators[0].(func(string) error)
	// promotionactivityDescEnabled is the schema descriptor for enabled field.
	promotionactivityDescEnabled := promotionactivityFields[3].Descriptor()
	...
	promotionactivityDescMaxUsesPerUser := promotionactivityFields[6].Descriptor()
	...
	promotionactivityDescCreatedAt := promotionactivityFields[7].Descriptor()
	...
	promotionactivityDescUpdatedAt := promotionactivityFields[8].Descriptor()
	...
	// promotionactivityparticipation.DefaultBonusDays holds the default value on creation for the bonus_days field.
	promotionactivityparticipation.DefaultBonusDays = promotionactivityparticipationDescBonusDays.Default.(int)
	...
	// promotionactivityparticipationDescBonusBalance is the schema descriptor for bonus_balance field.
	promotionactivityparticipationDescBonusBalance := promotionactivityparticipationFields[5].Descriptor()
	// promotionactivityparticipation.DefaultBonusBalance holds the default value on creation for the bonus_balance field.
	promotionactivityparticipation.DefaultBonusBalance = promotionactivityparticipationDescBonusBalance.Default.(float64)
	// promotionactivityparticipation.BonusBalanceValidator is a validator for the "bonus_balance" field. It is called by the builders before save.
	promotionactivityparticipation.BonusBalanceValidator = promotionactivityparticipationDescBonusBalance.Validators[0].(func(float64) error)
	// promotionactivityparticipationDescStatus is the schema descriptor for status field.
	promotionactivityparticipationDescStatus := promotionactivityparticipationFields[7].Descriptor()
	...
	promotionactivityparticipationDescReleaseReason := promotionactivityparticipationFields[11].Descriptor()
	...
	promotionactivityparticipationDescCreatedAt := promotionactivityparticipationFields[12].Descriptor()
	...
	promotionactivityparticipationDescUpdatedAt := promotionactivityparticipationFields[13].Descriptor()
	...
	// promotionactivityplan.DefaultBonusDays holds the default value on creation for the bonus_days field.
	promotionactivityplan.DefaultBonusDays = promotionactivityplanDescBonusDays.Default.(int)
	...
	// promotionactivityplanDescBonusBalance is the schema descriptor for bonus_balance field.
	promotionactivityplanDescBonusBalance := promotionactivityplanFields[3].Descriptor()
	// promotionactivityplan.DefaultBonusBalance holds the default value on creation for the bonus_balance field.
	promotionactivityplan.DefaultBonusBalance = promotionactivityplanDescBonusBalance.Default.(float64)
	// promotionactivityplan.BonusBalanceValidator is a validator for the "bonus_balance" field. It is called by the builders before save.
	promotionactivityplan.BonusBalanceValidator = promotionactivityplanDescBonusBalance.Validators[0].(func(float64) error)
	// promotionactivityplanDescCreatedAt is the schema descriptor for created_at field.
	promotionactivityplanDescCreatedAt := promotionactivityplanFields[4].Descriptor()
	...
	promotionactivityplanDescUpdatedAt := promotionactivityplanFields[5].Descriptor()
	...
	// subscriptionplanDescPresaleEnabled is the schema descriptor for presale_enabled field.
	subscriptionplanDescPresaleEnabled := subscriptionplanFields[13].Descriptor()
	// subscriptionplan.DefaultPresaleEnabled holds the default value on creation for the presale_enabled field.
	subscriptionplan.DefaultPresaleEnabled = subscriptionplanDescPresaleEnabled.Default.(bool)
	// subscriptionplanDescPresaleVisible is the schema descriptor for presale_visible field.
	subscriptionplanDescPresaleVisible := subscriptionplanFields[14].Descriptor()
	// subscriptionplan.DefaultPresaleVisible holds the default value on creation for the presale_visible field.
	subscriptionplan.DefaultPresaleVisible = subscriptionplanDescPresaleVisible.Default.(bool)
	// subscriptionplanDescPresaleBadge is the schema descriptor for presale_badge field.
	subscriptionplanDescPresaleBadge := subscriptionplanFields[15].Descriptor()
	// subscriptionplan.DefaultPresaleBadge holds the default value on creation for the presale_badge field.
	subscriptionplan.DefaultPresaleBadge = subscriptionplanDescPresaleBadge.Default.(string)
	// subscriptionplan.PresaleBadgeValidator is a validator for the "presale_badge" field. It is called by the builders before save.
	subscriptionplan.PresaleBadgeValidator = subscriptionplanDescPresaleBadge.Validators[0].(func(string) error)
	// subscriptionplanDescPresaleResetCards is the schema descriptor for presale_reset_cards field.
	subscriptionplanDescPresaleResetCards := subscriptionplanFields[16].Descriptor()
	// subscriptionplan.DefaultPresaleResetCards holds the default value on creation for the presale_reset_cards field.
	subscriptionplan.DefaultPresaleResetCards = subscriptionplanDescPresaleResetCards.Default.(int)
	// subscriptionplan.PresaleResetCardsValidator is a validator for the "presale_reset_cards" field. It is called by the builders before save.
	subscriptionplan.PresaleResetCardsValidator = func() func(int) error {
		validators := subscriptionplanDescPresaleResetCards.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
	...
	subscriptionplanDescCustomMultiplierEnabled := subscriptionplanFields[18].Descriptor()
	...
	subscriptionplanDescCustomMultiplierMin := subscriptionplanFields[19].Descriptor()
	...
	subscriptionplanDescCustomMultiplierMax := subscriptionplanFields[20].Descriptor()
	...
	subscriptionplanDescCreatedAt := subscriptionplanFields[21].Descriptor()
	...
	subscriptionplanDescUpdatedAt := subscriptionplanFields[22].Descriptor()
	...
	// usagelogDescRequestHost is the schema descriptor for request_host field.
	usagelogDescRequestHost := usagelogFields[34].Descriptor()
	// usagelog.RequestHostValidator is a validator for the "request_host" field. It is called by the builders before save.
	usagelog.RequestHostValidator = usagelogDescRequestHost.Validators[0].(func(string) error)
