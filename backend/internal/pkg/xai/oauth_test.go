...
func TestRuntimeSanityReportsSafeDefaults(t *testing.T) {
	...
	require.Equal(t, "responses_chat_messages_media", report.PublicGatewayScope)
...
func TestDefaultModelMappingIncludesGrokAliases(t *testing.T) {
	...
	require.NotContains(t, mapping, "grok-4.20-multi-agent-0309")
	require.Equal(t, "grok-imagine", mapping["grok-imagine"])
	require.Equal(t, "grok-imagine-image", mapping["grok-imagine-image"])
	require.Equal(t, "grok-imagine-image", mapping["grok-imagine-image-2026-03-02"])
	require.Equal(t, "grok-imagine-image-quality", mapping["grok-imagine-image-quality"])
	require.Equal(t, "grok-imagine-image-quality", mapping["grok-imagine-image-quality-20260403"])
	require.Equal(t, "grok-imagine-image-quality", mapping["grok-imagine-image-quality-latest"])
	require.Equal(t, "grok-imagine-image-quality", mapping["grok-imagine-image-pro"])
	require.Equal(t, "grok-imagine-image-quality", mapping["grok-imagine-edit"])
	require.Equal(t, "grok-imagine-image-quality", mapping["grok-imagine-image-edit"])
	...
	require.Equal(t, "grok-imagine-video-1.5", mapping["grok-imagine-video-1.5-preview"])
	require.Equal(t, "grok-imagine-video-1.5", mapping["grok-imagine-video-1.5-2026-05-30"])
}
