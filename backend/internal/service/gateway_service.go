...
func (s *GatewayService) initDebugGatewayBodyFile(path string) {
	...
	// #nosec G703 -- this operator-controlled debug path intentionally supports arbitrary local destinations.
	...
	if dir := filepath.Dir(path); dir != "." {
		// #nosec G703 -- the trusted operator explicitly selected the debug log directory.
	...
	// #nosec G703 -- the trusted operator explicitly selected the debug log file.
