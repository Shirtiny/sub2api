...
func buildNotifyVerifyEmailBody(code, siteName string) string {
	return renderEmailCard(siteName, notificationEmailLocaleChinese, "通知邮箱验证", `
<p>您正在添加额外的通知邮箱，请输入此验证码完成验证。</p>
<p>You are adding an extra notification email. Please enter this code to verify.</p>`+emailVerificationCode(code)+`
