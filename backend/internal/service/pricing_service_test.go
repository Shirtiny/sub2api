...
func TestDefaultPricingIncludesGPT56Variants(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{model: "gpt-5.6-sol", input: 5e-6, output: 30e-6, cached: 0.5e-6},
		{model: "gpt-5.6-terra", input: 2.5e-6, output: 15e-6, cached: 0.25e-6},
		{model: "gpt-5.6-luna", input: 1e-6, output: 6e-6, cached: 0.1e-6},
	} {
		...
		require.InDelta(t, tt.cached, got.CacheReadInputTokenCost, 1e-12, tt.model)
	}
}
