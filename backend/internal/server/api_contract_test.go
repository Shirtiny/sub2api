	...
	}{
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"balance_concurrency_rules": [
						{"min_balance": 0, "concurrency": 1},
						{"min_balance": 20, "concurrency": 2},
						{"min_balance": 100, "concurrency": 3}
					],
					"rpm_limit": 0,
					"status": "active",
					"allowed_groups": null,
			...
			wantJSON: `{
				...
				"data": {
					...
					"subscription_expiry_notify_enabled": true,
						...
						"cafe_coupon_config": {"levels":{"0":{"enabled":false,"type":"cash","value":0,"period":"month","transferable":false,"validity":"month_end","valid_until_month_end":true},"1":{"enabled":true,"type":"cash","value":5,"period":"month","transferable":false,"validity":"month_end","valid_until_month_end":true},"2":{"enabled":true,"type":"cash","value":10,"period":"month","transferable":false,"validity":"month_end","valid_until_month_end":true},"3":{"enabled":true,"type":"discount","value":10,"period":"month","transferable":false,"validity":"month_end","valid_until_month_end":true},"4":{"enabled":true,"type":"discount","value":15,"period":"month","transferable":false,"validity":"month_end","valid_until_month_end":true},"5":{"enabled":true,"type":"discount","value":15,"period":"month","transferable":true,"validity":"month_end","valid_until_month_end":true}}},
