...
func RegisterPaymentRoutes(
	...
	authenticated.Use(middleware.BackendModeUserGuard(settingService))
	{
		...
		cafeCoupons := authenticated.Group("/cafe-coupons")
		{
			...
			cafeCoupons.POST("/info", paymentHandler.CafeCouponInfo)
	...
	adminGroup.Use(gin.HandlerFunc(adminAuth))
	{
		...
		adminGroup.PUT("/presale-notice/config", adminPaymentHandler.UpdatePresaleNoticeConfig)
		...
		adminOrders := adminGroup.Group("/orders")
		{
			...
			adminOrders.POST("/:id/presale-offline", adminPaymentHandler.ProcessPresaleOffline)
		}
