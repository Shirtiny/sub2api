...
func UserFromServiceShallow(u *service.User) *User {
	...
	return &User{
		...
		MembershipLevel:            service.CalculateMembershipLevel(u.TotalRecharged),
		RPMLimit:                   u.RPMLimit,
...
// It includes the caller-owned request host/IP, but excludes upstream account details.
