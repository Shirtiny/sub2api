...
curl -sSL https://raw.githubusercontent.com/Shirtiny/sub2api/custom-prod/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/Shirtiny/sub2api/releases)
