  ...
  <div class="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-800/50">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <div class="mt-1 text-xs text-content-tertiary">
    ...
    <div v-if="mode === 'custom'" class="mt-4 space-y-4">
      <div class="flex items-center justify-between">
        <div class="text-sm font-medium text-content-primary">
          OR
          <span class="ml-1 text-xs font-normal text-content-tertiary">
            ({{ anyOf.length }}/50)
          </span>
        </div>
        <button
        ...
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            <div class="text-sm font-medium text-content-primary">
              ...
              <span class="ml-2 text-xs font-normal text-content-tertiary">AND ({{ (group.all_of?.length || 0) }}/50)</span>
            </div>
            <div class="mt-1 text-xs text-content-tertiary">
