      ...
      <div>
        ...
        <div class="flex gap-2">
          <div class="relative flex-1">
            ...
            <button v-if="form.password" type="button" @click="copyPassword" class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-1 transition-colors hover:bg-surface-hover" :class="passwordCopied ? 'text-green-500' : 'text-gray-400'">
...
watch(() => props.user, (u) => {
  if (u) {
    Object.assign(form, { email: u.email, password: '', username: u.username || '', notes: u.notes || '', concurrency: u.base_concurrency ?? u.concurrency, rpm_limit: u.rpm_limit ?? 0, customAttributes: {} })
