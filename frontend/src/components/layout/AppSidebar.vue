...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/presale', label: t('presale.nav'), icon: CreditCardIcon, hideInSimpleMode: true, featureFlag: flagPayment },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/waitlist', label: t('admin.waitlist.title'), icon: UsersIcon },
