    ...
    >
      ...
      >
        <div class="flex items-start gap-3">
          <div class="w-9 h-9 rounded-xl bg-stroke-subtle"></div>
          <div class="flex-1 space-y-2">
            <div class="h-4 w-2/3 rounded bg-stroke-subtle"></div>
            <div class="h-3 w-1/2 rounded bg-stroke-subtle"></div>
          </div>
          <div class="h-6 w-16 rounded-full bg-stroke-subtle"></div>
        </div>
