<template>
  <div class="mt-5 grid grid-cols-2 gap-2">
    <div
      class="rounded-xl p-3 bg-gray-50/80 dark:bg-dark-900/40 border border-stroke-subtle/50"
    >
      <div
      ...
      <div class="mt-1.5 text-lg font-bold font-mono tabular-nums text-content-primary">
