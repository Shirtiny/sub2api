<template>
  <AppLayout>
    <div class="space-y-6">
        ...
        <div class="card p-4">
          <div class="flex flex-wrap items-center gap-4">
            <div class="flex items-center gap-2">
              <span class="text-sm font-medium text-content-secondary">{{ t('admin.dashboard.timeRange') }}:</span>
              <DateRangePicker
            ...
            <div class="ml-auto flex items-center gap-2">
              <span class="text-sm font-medium text-content-secondary">{{ t('admin.dashboard.granularity') }}:</span>
              <div class="w-28">
      ...
      <div class="mb-4 flex gap-2 border-b border-stroke-default">
...
let abortController: AbortController | null = null; let exportAbortController: AbortController | null = null as AbortController | null
let chartReqSeq = 0
let statsReqSeq = 0
...
const exportToExcel = async () => {
  // Export is intentionally disabled while the xlsx dependency is removed for Security Scan.
}
