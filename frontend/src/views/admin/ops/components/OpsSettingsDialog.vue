  ...
  <BaseDialog :show="show" :title="t('admin.ops.settings.title')" width="extra-wide" @close="emit('close')">
    ...
    <div v-else-if="runtimeSettings && emailConfig && advancedSettings" class="space-y-6">
      ...
      <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-content-primary">{{ t('admin.ops.settings.dataCollection') }}</h4>
        <div>
      ...
      <!-- 预警配置 -->
      <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-content-primary">{{ t('admin.ops.settings.alertConfig') }}</h4>

        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <label class="font-medium text-content-primary">{{ t('admin.ops.settings.enableAlert') }}</label>
            </div>
      ...
      <!-- 评估报告配置 -->
      <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-content-primary">{{ t('admin.ops.settings.reportConfig') }}</h4>

        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <label class="font-medium text-content-primary">{{ t('admin.ops.settings.enableReport') }}</label>
            </div>
          ...
          <div v-if="emailConfig.report.enabled" class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="flex items-center justify-between">
              <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.dailySummary') }}</label>
            ...
            <div class="flex items-center justify-between">
              <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.weeklySummary') }}</label>
      ...
      <!-- 指标阈值配置 -->
      <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-content-primary">{{ t('admin.ops.settings.metricThresholds') }}</h4>
      ...
      <details class="rounded-2xl bg-gray-50 dark:bg-dark-700/50">
        <summary class="cursor-pointer p-4 text-sm font-semibold text-content-primary">
          {{ t('admin.ops.settings.advancedSettings') }}
        </summary>
        <div class="space-y-4 px-4 pb-4">
          <!-- 数据保留策略 -->
          <div class="space-y-3">
            <h5 class="text-xs font-semibold text-content-secondary">{{ t('admin.ops.settings.dataRetention') }}</h5>

            <div class="flex items-center justify-between">
              <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.enableCleanup') }}</label>
          ...
          <!-- 预聚合任务 -->
          <div class="space-y-3">
            <h5 class="text-xs font-semibold text-content-secondary">{{ t('admin.ops.settings.aggregation') }}</h5>

            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.enableAggregation') }}</label>
          ...
          <div class="space-y-3">
            <h5 class="text-xs font-semibold text-content-secondary">{{ t('admin.ops.settings.openaiQuotaAutoPause') }}</h5>
          ...
          <!-- Error Filtering -->
          <div class="space-y-3">
            <h5 class="text-xs font-semibold text-content-secondary">{{ t('admin.ops.settings.errorFiltering') }}</h5>

            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.ignoreCountTokensErrors') }}</label>
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.ignoreContextCanceled') }}</label>
                <p class="mt-1 text-xs text-gray-500">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.ignoreNoAvailableAccounts') }}</label>
                <p class="mt-1 text-xs text-gray-500">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.ignoreInvalidApiKeyErrors') }}</label>
                <p class="mt-1 text-xs text-gray-500">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.ignoreInsufficientBalanceErrors') }}</label>
                <p class="mt-1 text-xs text-gray-500">
          ...
          <!-- Auto Refresh -->
          <div class="space-y-3">
            <h5 class="text-xs font-semibold text-content-secondary">{{ t('admin.ops.settings.autoRefresh') }}</h5>

            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.enableAutoRefresh') }}</label>
                <p class="mt-1 text-xs text-gray-500">
          ...
          <!-- Dashboard Cards -->
          <div class="space-y-3">
            <h5 class="text-xs font-semibold text-content-secondary">{{ t('admin.ops.settings.dashboardCards') }}</h5>

            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.displayAlertEvents') }}</label>
                <p class="mt-1 text-xs text-gray-500">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-content-secondary">{{ t('admin.ops.settings.displayOpenAITokenStats') }}</label>
                <p class="mt-1 text-xs text-gray-500">
