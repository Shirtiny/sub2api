...
describe('user UsageView tooltip', () => {
  ...
  it('shows WS for WebSocket usage rows', async () => {
    query.mockResolvedValue({
      items: [
        {
          request_id: 'req-user-ws',
          request_type: 'ws_v2',
          stream: true,
          openai_ws_mode: true,
          actual_cost: 0,
  ...
  it('exports WebSocket usage as WS', async () => {
    const exportedLogs = [
      {
        request_id: 'req-user-export-ws',
        request_type: 'ws_v2',
        stream: true,
        openai_ws_mode: true,
        actual_cost: 0,
