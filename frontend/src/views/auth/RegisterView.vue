    ...
    <div class="space-y-6">
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="mail" size="md" class="text-content-tertiary" />
            </div>
            <input
              id="email"
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="lock" size="md" class="text-content-tertiary" />
            </div>
            <input
              id="password"
        ...
        <div v-if="invitationCodeRequired">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-green-500' : 'text-content-tertiary'" />
            </div>
            <input
              id="invitation_code"
        ...
        <div v-if="promoCodeEnabled">
          <label for="promo_code" class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-content-tertiary">({{ t('common.optional') }})</span>
          </label>
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-green-500' : 'text-content-tertiary'" />
            </div>
            <input
              id="promo_code"
