  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        logsHint: 'Only blocks and observation events are stored; details keep redacted headers and body metadata, never the original body. TLS data is observation-only.',
