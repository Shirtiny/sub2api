  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        protocolBlockingHint: 'When off, the policy still evaluates and records the expected result, but the request is observed and allowed without blocking, counting, or notifications. Anonymous Responses requests remain blocked.',
        ...
        detailBodyHint: 'Only fields, counts, session source, and compaction characteristics are shown. Candidate kinds are diagnostic inferences; the original body is never stored.',
