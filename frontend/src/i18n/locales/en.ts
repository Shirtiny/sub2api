  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        cafeCoupon: {
          title: 'Café Coupon',
          description: 'Configure Café coupon benefits by membership level. Claim period only controls claim frequency; it does not change coupon validity.',
          level0: 'Regular / LV.0',
          level1: 'LV.1',
          level2: 'LV.2',
          level3: 'LV.3',
          ...
          monthEndValidityHint: 'Whether the claim period is daily, weekly, or monthly, the coupon expires at the last moment of its claim month.',
