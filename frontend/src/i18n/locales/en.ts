  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        logsHint: 'Records are deduplicated by user, request protocol, and redacted header/body metadata fingerprints. Actual and expected outcomes are shown; original bodies are never stored and TLS data is observation-only.',
        ...
        detailBodyHint: 'Only fields, counts, and client identifiers are shown; the original body is never stored.',
