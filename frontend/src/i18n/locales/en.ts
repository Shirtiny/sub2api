  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        logsHint: 'Records are aggregated by user, request protocol, and redacted header/body metadata fingerprints. Aggregate count, first/last seen time, session source, and compaction evidence are shown; original bodies are never stored and TLS data is observation-only.',
        ...
        detailBodyHint: 'Only fields, counts, session source, and compaction characteristics are shown. Explicit or strong-shape compaction requests are observed and allowed; the original body is never stored.',
