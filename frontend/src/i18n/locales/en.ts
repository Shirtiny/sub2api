  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        logsHint: 'Records are aggregated by user and request-format fingerprint with count and first/last seen time. The detail snapshot refreshes at most once per 15 minutes and includes request context, multi-value headers with authentication credentials redacted, body head/tail, full-body hash, session source, and compaction evidence. Body snapshots are capped at 256KB and kept for 3 days; base records are kept for 30 days.',
