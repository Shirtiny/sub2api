  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        logsHint: 'New records are stored per request; historical aggregate rows retain their occurrence count. Details include request context, multi-value headers with authentication credentials redacted, a body diagnostic snapshot, full-body hash, session source, and compaction evidence. Body snapshots are kept for 7 days and base records for 30 days.',
        ...
        singleEvent: 'Individual request',
        ...
        snapshotUnavailable: 'No request snapshot is available. The record may predate full snapshots or its snapshot may have exceeded the 7-day retention period.',
