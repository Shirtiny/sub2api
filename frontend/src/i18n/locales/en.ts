  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        requestSnapshot: 'Also save observed-request snapshots',
        requestSnapshotHint: 'Actually blocked requests always retain a diagnostic snapshot. The switch is off by default; enabling it also captures observed requests with redacted headers and up to 256KB of body head/tail for 3 days. Disabling it only stops new observed-request snapshots.',
        ...
        logsHint: 'Records are aggregated by user and request-format fingerprint with count and first/last seen time. Actually blocked requests always retain a diagnostic snapshot; enabling the snapshot switch also captures observed requests. Details refresh at most once per 15 minutes; body snapshots are capped at 256KB and kept for 3 days. Base records are kept for 30 days.',
        ...
        snapshotUnavailable: 'No request snapshot is available. The record may be historical, its snapshot may have exceeded the 3-day retention period, or capture/storage may have degraded.',
