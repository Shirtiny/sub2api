  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        requestSnapshotHint: 'Off by default. When enabled, blocked or observed requests retain redacted headers and up to 256KB of body head/tail for 3 days; disabling it stops new snapshot capture.',
        ...
        logsHint: 'Records are aggregated by user and request-format fingerprint with count and first/last seen time. When request diagnostic snapshots are enabled, details refresh at most once per 15 minutes; body snapshots are capped at 256KB and kept for 3 days. Base records are kept for 30 days.',
        ...
        snapshotUnavailable: 'No request snapshot is available. Capture may be disabled, the record may predate this feature, or its snapshot may have exceeded the 3-day retention period.',
