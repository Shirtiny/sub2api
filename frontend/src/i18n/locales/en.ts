export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      bulkResetQuotaConfirm: 'Reset daily, weekly, and monthly usage quotas for all active subscriptions? This affects every active subscription, not just the current filters or page.',
