  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        noUserRules: '暂无用户规则',
        logsTitle: '管控记录',
        logsHint: '新记录按每次请求独立保存；历史聚合记录仍展示聚合次数。详情包含完整请求上下文、认证头脱敏后的多值请求头、正文诊断快照、完整正文哈希、会话来源和压缩证据。正文快照保留 7 天，基础记录保留 30 天。',
        refresh: '刷新记录',
        ...
        snapshotUnavailable: '该记录没有请求快照：可能创建于完整快照功能上线前，或快照已超过 7 天保留期。',
