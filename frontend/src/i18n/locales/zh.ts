  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        requestSnapshotHint: '默认关闭。开启后仅为被拦截或观察的请求保存脱敏请求头和最多 256KB 的正文头尾，快照保留 3 天；关闭后不采集新快照。',
        ...
        noUserRules: '暂无用户规则',
        logsTitle: '管控记录',
        logsHint: '按用户与请求格式指纹聚合，展示次数和首次/末次时间。开启请求诊断快照后，详情最多每 15 分钟刷新一次，正文快照最多 256KB、保留 3 天；基础记录保留 30 天。',
        refresh: '刷新记录',
        ...
        snapshotUnavailable: '该记录没有请求快照：可能未开启请求诊断快照、创建于该功能上线前，或快照已超过 3 天保留期。',
