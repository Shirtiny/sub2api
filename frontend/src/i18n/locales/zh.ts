  ...
  admin: {
    ...
    riskControl: {
      ...
      requestControl: {
        ...
        noUserRules: '暂无用户规则',
        logsTitle: '管控记录',
        logsHint: '按用户、请求格式以及请求头/请求体元数据指纹聚合；展示聚合次数、首次/末次时间、会话来源和压缩请求证据。详情只保存脱敏元数据，不保存原始正文；TLS 信息只用于观察。',
        refresh: '刷新记录',
        ...
        detailBodyHint: '仅展示字段、数量、会话来源与压缩特征等元数据；明确或强特征命中的压缩请求只观察放行，原始正文不会保存。',
        emptyLogs: '暂无请求管控记录',
